{- |
    ...
    SDP.ByteString.Related is service module that contains Default and Arbitrary
    instances for ByteString (this implementations do not require installation
    of additional libraries because SDP depends on data-default and QuickCheck).
